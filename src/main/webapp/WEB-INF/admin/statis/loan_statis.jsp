...
<div class="wrapper wrapper-content">
	<div class="row">
		...
		<div class="col-sm-2">
			<div class="ibox float-e-margins">
                <div class="ibox-title">
                    <span class="label label-success pull-right">今</span>
                    <h5>今日贷款</h5>
                </div>
                <div class="ibox-content">
...
$(function(){
	...
	Ajax.ajax({
		url: "admin/statis/loanStatData.do",
		params: null,
		success: function(data) {
			...
			$("#data2-1").html(data.c);
			$("#data2-2").html(data.d);
			$("#data2-3").html(data.e / 10000);
			$("#data2-4").html(data.f / 10000);
		}
	});
});
...
function stat(type){
	...
	Ajax.ajax({
		url: "admin/statis/loanStatChart.do",
		params: {"type":type},
		success: function(data) {
            if (data.code == 0) {
                myChart.setOption(
