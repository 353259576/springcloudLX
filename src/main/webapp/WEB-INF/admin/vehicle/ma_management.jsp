                ...
                <div class="row">
                    <div class="col-sm-12">
                        <form action="" method="post" class="form-inline" id="queryForm">
                            ...
                            <label> 单车状态:<input type="text" name="vezt" value=""  class="form-control input-sm"></label>
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        <tr>
                                ...
                                <td>报修</td>
                                <td>
                                    <a class="btn btn-sm btn-circle btn-warning" title="" href="madetial.jsp" data-open="modal" data-toggle="tooltip" data-placement="top" data-original-title="详情"><i class="fa fa-info-circle"></i></a>
                                </td>
                            </tr>    
                        <tr>
                                <td>1</td>
