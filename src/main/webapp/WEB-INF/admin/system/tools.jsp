...
<body class="gray-bg">
	...
	<div class="tab-content">
			                ...
			                <div class="ibox-content">
			                    ...
			                    <form role="form" class="form-horizontal m-t">
			                        ...
			                        <div class="form-group draggable">
			                            ...
			                            <div class="col-sm-9">
			                                <a class="btn btn-sm btn-info" href="javascript:uploadImg(2,'avatar');"><i class="fa fa-picture-o"></i>选择图片</a>
											<input type="hidden" name="avatar" id="avatar" value="">
											<div img-area-id="avatar"></div>
			                            </div>
			                        </div>
			                        <div class="form-group draggable">
			                            ...
			                            <div class="col-sm-9">
			                                <label class="radio-inline i-checks">
			                                    <input type="radio" checked="checked" value="" id="optionsRadios1" name="optionsRadios">选项1</label>
			                                <label class="radio-inline i-checks">
			                                    <input type="radio" value="" id="optionsRadios2" name="optionsRadios">选项2</label>
			                            </div>
			                        </div>
			                        <div class="form-group draggable">
			                            ...
			                            <div class="col-sm-9">
			                                <label class="checkbox-inline i-checks">
			                                    <input type="checkbox" value="" id="inlineCheckbox1">选项1</label>
			                                <label class="checkbox-inline i-checks">
			                                    <input type="checkbox" value="" id="inlineCheckbox2">选项2</label>
			                                <label class="checkbox-inline i-checks">
			                                    <input type="checkbox" value="" id="inlineCheckbox3">选项3</label>
			                            </div>
			                        </div>
                                    <div class="form-group draggable">
			        ...
			        <div class="ibox-content">
			        	<div class="row">
			        		<div class="col-md-6">
					    		<div class="input-group"><span class="input-group-addon"><i class="fa fa-globe"></i></span>
					                <input id="requestUrl" type="text" placeholder="请求地址" class="form-control" value="<%=basePath%>testJson.do">
					            </div>
			        		</div>
				            <div class="col-md-6">
			        	...
			        	<div>
				        	<div class="row mt15">
				        		...
				        		<div class="col-md-3"><input type="text" class="form-control" value="" name="auth" placeholder="auth_code"></div>
				        	</div>
			        	</div>
			        	<div id="requestParam">
				        	<div class="row request-param mt15">
				        		...
				        		<div class="col-md-1"><a class="btn-del-param" title="删除"><i class="fa fa-times"></i></a></div>
				        	</div>
			        	</div>
			        	<div class="mt20">
        ...
        <div role="tabpanel" class="tab-pane fade" id="js">
            <div class="wrapper-content">
                <a class="btn btn-sm btn-info btn-tools" title="图标库" data-url="admin/system/icons.do">font-awesome图标库</a>
                <a class="btn btn-sm btn-warning btn-tools" title="Bootstrap表单构造器" data-url="http://www.bootcss.com/p/bootstrap-form-builder/">第三方表单构建工具</a>
                <a class="btn btn-sm btn-warning btn-tools" title="Json验证器" data-url="http://www.bejson.com#JSONValidate">Json验证器</a>
                <a class="btn btn-sm btn-warning btn-tools" title="CSS格式化" data-url="http://www.bejson.com/otherformat/css/#content">CSS格式化</a>
                <a class="btn btn-sm btn-warning btn-tools" title="Json转实体类" data-url="http://www.bejson.com/json2javapojo#basic-addon1">Json转实体类</a>
                <a class="btn btn-sm btn-warning btn-tools" title="二维码解码和生成" data-url="http://www.bejson.com/convert/qrcode#encode-text">二维码解码和生成</a>
                <a class="btn btn-sm btn-warning btn-tools" title="Unix时间戳" data-url="http://www.bejson.com/convert/unix#basic-addon1">Unix时间戳转换</a>
                <a class="btn btn-sm btn-warning btn-tools" title="正则表达式测试" data-url="http://www.bejson.com/othertools/regex#textSour">正则表达式测试</a>
            </div>
        </div>
	</div>
...
<script type="text/javascript" src="static/library/plugins/iCheck/icheck.min.js"></script>
<script type="text/javascript">
	$(document).ready(function () {
		...
		$(".btn-tools").click(function(){
			...
			var index = openLayerFrame(name, document.body.scrollWidth-100+"px", "600px", url, true);
			layer.full(index);
		});
...
<script type="text/javascript">
	$(function(){
		$("#executeUpdate").click(function(){
			if(checkString("#updateSql",10,1000)){ return; }
			Ajax.ajax({
				url: "admin/system/executeUpdate.do",
		...
		$("#executeQuery").click(function(){
			if(checkString("#querySql",10,1000)){ return; }
			Ajax.ajax({
				url: "admin/system/executeQuery.do",
