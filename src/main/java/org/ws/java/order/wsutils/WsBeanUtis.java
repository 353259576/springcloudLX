...
import org.ws.java.order.model.vo.OrderVO;
import org.ws.java.order.wsutils.lx.BaseDemoObject;
import org.ws.java.order.wsutils.lx.DataBox;
...
public class WsBeanUtis {
    ...
    public static void main(String[] args) {
        BaseDemoObject baseDemoObject = new BaseDemoObject();
        baseDemoObject.setId("12354");
        baseDemoObject.setContext("你好世界");
        baseDemoObject.setOrderEffectiveDate(123456789l);
        Map map = new HashMap();
        map.put("132","256");
        map.put("151","123");
        map.put("152","sdf");
        baseDemoObject.setMap(map);
        DataBox dataBox = new DataBox();
        Long startTime = System.currentTimeMillis();
        dataBox = copyField(baseDemoObject, dataBox);
        Long endTime = System.currentTimeMillis();
        System.out.println(endTime - startTime);
        Map<String,Long> map1 = dataBox.getMap();
        Long value = map1.get("152");
        System.out.println(value);
        System.out.println(JSON.toJSONString(dataBox));
    }
            ...
            if(tClass==int.class){
                ...
                if(object.getClass()==Date.class){
                    ...
                    try {
                        ...
                        Long dateNum = Long.valueOf(String.valueOf(object));
                        if(dateNum != null){
                ...
                try {
                    Object newObject = tClass.newInstance();
